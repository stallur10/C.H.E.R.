...
from_number = '18775066761'  # Twilio phone number
to_number = '12242398445'       # Recipient's phone number
message = 'Your loved one has been feeling down lately, make sure to check up on them when you get the chance!'
...
# Line graph for Sadness over the entire session
